...
# Present a menu of different places in outer space to travel to.
# Allow the user to pick a place from the menu.
# Calculate the distance to the object.
# Ask the user how fast they want to go.
# Make sure it's not faster than the speed of light.
# Calculate TIME by Distance / Speed (/ means DIVIDE in programming)
