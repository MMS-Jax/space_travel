...
// How fast do you want to go?  Measured in Km/s. 
var YOUR_VARIABLE_HERE = // What goes here? 

// Make sure we are not violating the fundamental laws of physics. 
if (YOUR_VARIABLE_HERE ? 300000) { // Replace the ? with >, <, OR ==.
    var YOUR_VARIABLE_HERE = prompt("Enter your speed measured in Km/s.  Do not exceed the speed of light, 300,000 Km / s.");        
} else {
    console.log("You entered " + YOUR_VARIABLE_HERE + " Km / s.");
}
...
if (travelTime ? maxTravelTime) { //  Replace the ? with >, <, OR ==.
    console.log("At the chosen speed, the mission will exceed the three year limit on travel time.  The mission cannot succeed.");
} else {
